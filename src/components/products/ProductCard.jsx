  ...
  const handleBasketButton = () => {
    ...
    if (basketProduct) {
      ...
      let addProduct = {
        ...product,
        basketAmount: amount,
        basketPrice: product.price - product.discount,
      };
      ...
      <div className="image">
        ...
        <div className="icons">
          ...
          <button
            ...
            data-bs-target="#basket-offcanvas"
          >
      ...
      <div className="details">
        <div className="price">
          {product.discount === 0 ? (
            ...
            <>
              <span className="old-price">{product.price.toFixed(2)} Dt</span>
              <span className="new-price">
                {(product.price - product.discount).toFixed(2)} Dt
              </span>
            </>
          )}
        </div>
